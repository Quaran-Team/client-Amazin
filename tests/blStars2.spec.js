...
// below will fail since className is omitted... looks for an exact === match 

// describe(" 2nd time it should display at least one star ", () => {
//   it('2x contains a star unicode element', () => {
//     const wrapper = shallow(<LowStar />);
//     const magicWords =<span >&#9733;</span>;
//     expect(wrapper.contains(magicWords)).toEqual(true);
//   });
// });